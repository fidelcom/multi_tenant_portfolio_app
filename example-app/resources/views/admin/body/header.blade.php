...
{{--            </div>--}}
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ (!empty($adminData->profile_image)) ? url('upload/admin/profile_images/'.$adminData->profile_image) : asset('backend/assets/images/small/img-5.jpg') }}"
                         alt="Header Avatar">
