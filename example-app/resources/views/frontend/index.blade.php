            ...
            <div class="row gx-0 services__active">
                    ...
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="frontend/assets/img/icons/services_light_icon01.png"
                                    alt="">
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="frontend/assets/img/icons/services_light_icon02.png"
                                    alt="">
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="frontend/assets/img/icons/services_light_icon03.png"
                                    alt="">
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="frontend/assets/img/icons/services_light_icon04.png"
                                    alt="">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 order-0 order-lg-2">
                    <ul class="testimonial__avatar__img">
                        ...
                        <li><img src="frontend/assets/img/images/testi_img02." alt=""></li>
