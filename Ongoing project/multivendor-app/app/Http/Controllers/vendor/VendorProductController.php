...
class VendorProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('vendor.product.create_product', compact('categories', 'subcategories', 'brands', 'vendors'));
    }
...
//        dd($product);
        ...
        return redirect()->route('vendor.product.home')->with([
    ...
    public function edit(Product $product)
    {
        ...
        $vendors = User::where('role', 'vendor')->orderBy('name', 'DESC')->get();
//        dd($product);
        return view('vendor.product.edit_product', compact('categories', 'subcategories', 'product', 'brands', 'vendors'));
    }
...
//        dd($product);
        $categories = ProductCategory::all();
        $subcategories = ProductSubcategory::all();
        return view('vendor.product.edit_product', compact('categories', 'subcategories', 'product'));
    }
