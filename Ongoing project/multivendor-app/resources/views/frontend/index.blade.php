...
@section('main')
    ...
    <div class="rts-banner-area rts-section-gap banner-bg_4 bg_image  d-flex align-items-center">
        <div class="transparent-person">
            <img src="{{ asset('frontend/assets/images/banner/transparent/01.png') }}" alt="banenr">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="banner-area-start-4">
                        <span class="pre">Get up to -30% off on your purchase</span>
                        <h1 class="title">Buy From Different Kind <br>
                            of Grocery Store</h1>
                                                        ...
                                                        @foreach($categories as $category)
                                                            <div class="swiper-slide">
                                                                <div class="single-category-one height-180">
                                                                    <a href="{{ route('category.product', ['category' => $category->id, 'slug' => $category->slug]) }}">
                                                                        <img src="{{ asset($category->image) }}" alt="category">
                                                                        <p>{{ $category->name }}</p>
                                                                        <span>{{ count($category->product) }} Items</span>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                    ...
                                    <div class="title-area-between">
                                        ...
                                        <ul class="nav nav-tabs best-selling-grocery" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link {{ $key > 0 ? '' : 'active' }}" id="home-tab{{ $key }}" data-bs-toggle="tab" data-bs-target="#home{{ $key }}" type="button" role="tab" aria-controls="home" aria-selected="true">{{ $category_product->name }}</button>
                                            </li>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        @foreach($category_products as $key => $category_product)
                                        <div class="tab-pane fade show {{ $key > 0 ? '' : 'active' }}" id="home{{ $key }}" role="tabpanel" aria-labelledby="home-tab{{ $key }}">
                                            <div class="row g-4">
                                                        ...
                                                        @foreach($special_offers as $special_offer)
                                                            <div class="swiper-slide">
                                                                <div class="single-shopping-card-one tranding-product">
                                                                    <a href="{{ route('single.product', ['product' => $special_offer->id, 'slug' => $special_offer->slug]) }}" class="thumbnail-preview">
                                                                        <img src="{{ asset($special_offer->product_thumbnail) }}" alt="grocery">
                                                                    </a>
                                                                    <div class="body-content">
                                                                        <a href="{{ route('single.product', ['product' => $special_offer->id, 'slug' => $special_offer->slug]) }}">
                                                                            <h4 class="title">{{ $special_offer->name  }}</h4>
                                                                        </a>
                                                                        @if($special_offer->weight)
                                                                        <span class="availability">{{ $special_offer->weight }}</span>
                                                                        @endif
                                                                        <div class="price-area">
                                                                            @if($special_offer->discount)
                                                                            <span class="current">${{ number_format($special_offer->discount, 2) }}</span>
                                                                            <div class="previous">${{ number_format($special_offer->price, 2 ) }}</div>
                                                                            @else
                                                                                <span class="current">${{ number_format($special_offer->price, 2) }}</span>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    <div class="weekly-best-deals-top-primary rts-section-gapTop">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="weekly-best-deals-top-primary-wrapper">
                        <div class="title-area-between with-progress">
                            ...
                            <div class="countdown">
                                <div class="countDown">10/12/2024 10:20:00</div>
                            </div>
                        </div>
    ...
    <div class="four-feature-in-one rts-section-gapTop">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3">
                    <!-- single four feature -->
                    <div class="feature-product-list-wrapper">
                        ...
                        @foreach($recentlyAdded as $recent_product)
                            <div class="single-product-list">
                                <a href="{{ route('single.product', ['product' => $recent_product->id, 'slug' => $recent_product->slug]) }}" class="thumbnail">
                                    <img src="{{ asset($recent_product->product_thumbnail) }}" style="width: 100px" alt="product">
                                </a>
                                <div class="body-content">
                                    <div class="top">
                                        <div class="stars-area">
                                        ...
                                        <a href="{{ route('single.product', ['product' => $recent_product->id, 'slug' => $recent_product->slug]) }}">
                                            <h4 class="title">{{ $recent_product->name }}</h4>
                                        </a>
                                        <div class="price-area">
                                            @if($recent_product->discount)
                                                <span class="current">${{ number_format($recent_product->discount, 2) }}</span>
                                                <div class="previous">${{ number_format($recent_product->price, 2 ) }}</div>
                                            @else
                                                <span class="current">${{ number_format($recent_product->price, 2) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="feature-product-list-wrapper">
                        ...
                        @foreach($top_products as $top_product)
                            <div class="single-product-list">
                                <a href="{{ route('single.product', ['product' => $top_product->id, 'slug' => $top_product->slug]) }}" class="thumbnail">
                                    <img src="{{ asset($top_product->product_thumbnail) }}" style="width: 100px" alt="product">
                                </a>
                                <div class="body-content">
                                    <div class="top">
                                        <div class="stars-area">
                                        ...
                                        <a href="{{ route('single.product', ['product' => $top_product->id, 'slug' => $top_product->slug]) }}">
                                            <h4 class="title">{{ $top_product->name }}</h4>
                                        </a>
                                        <div class="price-area">
                                            @if($top_product->discount)
                                                <span class="current">${{ number_format($top_product->discount, 2) }}</span>
                                                <div class="previous">${{ number_format($top_product->price, 2 ) }}</div>
                                            @else
                                                <span class="current">${{ number_format($top_product->price, 2) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="feature-product-list-wrapper">
                        ...
                        @foreach($best_offers as $best_offer)
                            <div class="single-product-list">
                                <a href="{{ route('single.product', ['product' => $best_offer->id, 'slug' => $best_offer->slug]) }}" class="thumbnail">
                                    <img src="{{ asset($best_offer->product_thumbnail) }}" style="width: 100px" alt="product">
                                </a>
                                <div class="body-content">
                                    <div class="top">
                                        <div class="stars-area">
                                        ...
                                        <a href="{{ route('single.product', ['product' => $best_offer->id, 'slug' => $best_offer->slug]) }}">
                                            <h4 class="title">{{ $best_offer->name }}</h4>
                                        </a>
                                        <div class="price-area">
                                            @if($best_offer->discount)
                                                <span class="current">${{ number_format($best_offer->discount, 2) }}</span>
                                                <div class="previous">${{ number_format($best_offer->price, 2 ) }}</div>
                                            @else
                                                <span class="current">${{ number_format($best_offer->price, 2) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="feature-product-list-wrapper">
                        ...
                        @foreach($new_products as $new_product)
                            <div class="single-product-list">
                                <a href="{{ route('single.product', ['product' => $new_product->id, 'slug' => $new_product->slug]) }}" class="thumbnail">
                                    <img src="{{ asset($new_product->product_thumbnail) }}" style="width: 100px" alt="product">
                                </a>
                                <div class="body-content">
                                    <div class="top">
                                        <div class="stars-area">
                                        ...
                                        <a href="{{ route('single.product', ['product' => $new_product->id, 'slug' => $new_product->slug]) }}">
                                            <h4 class="title">{{ $new_product->name }}</h4>
                                        </a>
                                        <div class="price-area">
                                            @if($new_product->discount)
                                                <span class="current">${{ number_format($new_product->discount, 2) }}</span>
                                                <div class="previous">${{ number_format($new_product->price, 2 ) }}</div>
                                            @else
                                                <span class="current">${{ number_format($new_product->price, 2) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
