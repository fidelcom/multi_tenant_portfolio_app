            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="navigator-breadcrumb-wrapper">
                        ...
                        <a class="current" href="{{ route('shop.vendor.home') }}">Vendor</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="single-vendor-area">
                                            <div class="logo-vendor">
                                                <img src="{{ asset($vendor->photo) }}" alt="vendor">
                                            </div>
                                            <h3 class="title">{{ $vendor?->vendor?->organization }} <span class="closed">Closed</span></h3>
                                            ...
                                            <div class="location">
                                                ...
                                                <p>{{ $vendor?->vendor?->organization_address }}</p>
                                            </div>
                                            <div class="location">
                                                <i class="fa-solid fa-phone-volume"></i>
                                                <p>{{ $vendor?->vendor?->organization_phone }}
                                                </p>
                                            </div>
                                            <a href="{{ route('shop.vendor.product', ['user' => $vendor->id]) }}" class="rts-btn btn-primary radious-sm with-icon">
                                                <div class="btn-text">
                                                    Visit Store
                                                </div>
                                                <div class="arrow-icon">
                        ...
                        <div class="with-list mt--20 tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="single-vendor-area">
                                        <div class="logo-vendor">
