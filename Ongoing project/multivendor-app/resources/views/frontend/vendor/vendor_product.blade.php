            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="navigator-breadcrumb-wrapper">
                        ...
                        <a class="current" href="#">{{ $vendor->vendor->organization }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="vendor-name-area-details">
                        <h1 class="title">{{ $vendor->vendor->organization }}</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-3">
                                <div class="vendor-banner-left">
                                    ...
                                    <div class="header-area">
                                        <h4 class="title">{{ $vendor->vendor->organization }} <span>Open</span></h4>
                                    </div>
                                    ...
                                    <div class="location">
                                        ...
                                        <p>{{ $vendor->vendor->organization_phon }}
                                        </p>
                                    </div>
                                    <div class="location">
                                        <i class="fa-regular fa-cart-shopping"></i>
                                        <p>{{ count($products) }} Product Available
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="product-area-add-wrapper bg_image">
                                ...
                                <img src="assets/images/vendor/01.png" alt="" class="one">
                                <img src="assets/images/vendor/02.png" alt="" class="two">
                            </div>
                        </div>
                    </div>
