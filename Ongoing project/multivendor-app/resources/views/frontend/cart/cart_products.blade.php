...
{{--                                    </div>--}}
{{--                                    <div class="thumbnail">--}}
{{--                                        <img src="{{ asset($product?->options->image) }}" alt="shop">--}}
{{--                                    </div>--}}
...
{{--                                        <input type="text" class="input" value="{{ $product->qty }}">--}}
{{--                                        <div class="button-wrapper-action">--}}
{{--                                            <button class="button"><i class="fa-regular fa-chevron-down"></i></button>--}}
{{--                                            <button class="button plus" id="{{ $product->rowId }}" onclick="cartDecrement(this.id)">+<i class="fa-regular fa-chevron-up"></i></button>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="subtotal">--}}
...
{{--                            </form>--}}
                ...
                <div class="col-xl-3 col-lg-12 col-md-12 col-12 order-1 order-xl-2 order-lg-1 order-md-1 order-sm-1">
                    <div class="cart-total-area-start-right">
                        ...
                        <div class="subtotal">
                            <span>Subtotal</span>
                            <h6 class="price" id="cartPageSubTotal">$1100.00</h6>
                        </div>
                        <div class="shipping">
                            <span>Shipping</span>
                            <ul>
                        ...
                        <div class="bottom">
                            <div class="wrapper">
                                <span>Subtotal</span>
                                <h6 class="price" id="cartPageTotal">$1100.00</h6>
                            </div>
                            <div class="button-area">
                                <a href="{{ route('checkout.home') }}" class="rts-btn btn-primary">Proceed To Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
