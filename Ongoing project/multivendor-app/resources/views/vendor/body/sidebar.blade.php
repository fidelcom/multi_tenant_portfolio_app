<div class="section-menu-left">
    <div class="box-logo">
        <a href="{{ route('vendor.dashboard') }}" id="site-logo-inner">
        ...
        <div class="center-item">
            ...
            <ul class="menu-list">
                <li class="menu-item active">
                    <a href="{{ route('vendor.dashboard') }}" class="menu-item-button">
                ...
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('vendor.product.create') }}" class="">
                                <div class="text">Add Product</div>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a href="{{ route('vendor.product.home') }}" class="">
...
{{--                </li>--}}
        ...
        <div class="center-item">
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="{{ route('vendor.profile.home') }}" class="">
