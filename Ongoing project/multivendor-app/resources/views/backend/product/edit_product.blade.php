...
@section('admin')
    ...
    <div class="main-content-wrap">
        ...
        <!-- form-add-product -->
        <form class="tf-section-2 form-add-product" method="POST" action="{{ route('product.update', [ 'product' => $product->id ]) }}" enctype="multipart/form-data">
            @csrf @method('PUT')
            <div class="wg-box">
                <fieldset class="name">
                ...
                <fieldset class="name">
                    ...
                    <div class="">
                        <input type="number" name="price" min="1" placeholder="Product Price" value="{{ $product->price }}" required>
                    </div>
                </fieldset>
                <fieldset class="name">
                    <div class="body-title mb-10">Product Discount Price</div>
                    <div class="">
                        <input type="number" name="discount" min="1" placeholder="Discount Price" value="{{ $product->discount }}">
                    </div>
                </fieldset>
                <fieldset class="name">
                    <div class="body-title mb-10">Product Quantity</div>
                    <div class="">
                        <input type="number" name="qty" min="1" placeholder="Product Quantity" value="{{ $product->qty }}" required >
                    </div>
                </fieldset>
                ...
                <fieldset class="brand">
                    <div class="body-title mb-10">Vendor <span class="tf-color-1">*</span></div>
                    <div class="select">
                ...
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="short_desc" placeholder="Short Description" tabindex="0" aria-required="true" required="">
                        {{ $product->short_desc }}
                    </textarea>
                ...
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="long_desc" placeholder="Long Description" tabindex="0" aria-required="true" required="">
                        {{ $product->long_desc }}
                    </textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the product name.</div>
                </fieldset>
                <fieldset class="description">
                    ...
                    <textarea class="mb-10" name="specification" placeholder="Specification" tabindex="0" aria-required="true" required="">
            ...
            <div class="wg-box">
                ...
                <fieldset class="name">
                    ...
                    <div class="mb-10">
                        <div class="flex items-center w-full">
                            <input type="text" id="size" name="size" value="{{ $product->size }}" class="w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500" placeholder="Enter size..." >
                            <div id="tags"></div>
                        </div>
                    </div>
                </fieldset>
                <fieldset class="name">
                    ...
                    <div class="mb-10">
                        <div class="flex items-center w-full">
                            <input type="text" id="color" name="color" value="{{ $product->color }}" class="w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500" placeholder="Enter colors..." >
                ...
                <fieldset class="name">
                    ...
                    <div class="mb-10">
                        <div class="flex items-center w-full">
                            <input type="text" id="tags" name="tags" class="w-full px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500" value="{{ $product->tags }}" placeholder="Enter tags..." >
                            <div id="tag_tags"></div>
                        </div>
                    </div>
                </fieldset>
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <div class="">
                            <input type="checkbox" name="best_seller" placeholder="GF423G" value="1" {{ $product->best_seller == 1 ? 'checked' : '' }}>
                        </div>
                    </fieldset>
                    <fieldset class="name">
                        <div class="body-title mb-10">Featured product</div>
                        <div class="">
                            <input type="checkbox" name="featured" placeholder="GF423G" value="1" {{ $product->featured == 1 ? 'checked' : '' }}>
                        </div>
                    </fieldset>
                    <fieldset class="name">
                        <div class="body-title mb-10">Top product</div>
                        <div class="">
                            <input type="checkbox" name="top_product" value="1" {{ $product->top_product == 1 ? 'checked' : '' }}>
                        </div>
                    </fieldset>
                </div>
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <div class="">
                            <input type="checkbox" name="best_offer" value="1" {{ $product->best_offer == 1 ? 'checked' : '' }}>
                        </div>
                    </fieldset>
                    <fieldset class="name">
                    ...
                    <fieldset class="name">
                        ...
                        <div class="">
                            <input type="checkbox" name="new_product" value="1" {{ $product->new_product == 1 ? 'checked' : '' }}>
                        </div>
                    </fieldset>
                </div>
                <fieldset class="name">
                    ...
                    <div class="">
                        <input type="text" name="product_code" placeholder="GF423G" value="{{ $product->product_code }}">
                    </div>
                </fieldset>
                <fieldset class="name">
                    <div class="body-title mb-10">Product video url</div>
                    <div class="">
                        <input type="url" name="video_url" placeholder="Product video url" value="{{ $product->video_url }}">
                    </div>
                </fieldset>
                <fieldset class="name">
                    <div class="body-title mb-10">Product Weight</div>
                    <div class="">
                        <input type="number" name="weight" placeholder="Weight" value="{{ $product->weight }}">
                    </div>
                </fieldset>
                {{--                </div>--}}
        ...
        <!-- /form-add-product -->
        <!-- form-add-product -->
        <form class="tf-section-2 form-add-product bg-white mt-5" method="POST" action="{{ route('product.image', $product->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="wg-box">
                <fieldset>
                    <div class="body-title mb-10">Other product images</div>
                    <div class="upload-image mb-16">
                        @foreach($product->product_multiImage as $img)
                            <div class="item">
                                <div>
                                    <img src="{{ asset($img->name) }}" alt="">
                                    {{--                                <div class="cols gap10">--}}
                                        <a href="{{ route('product.image.delete', $img->id) }}" class="tf-button-download w-full" type="submit">Delete</a>
                                </div>
...
{{--                                </div>--}}
            ...
            <div class="wg-box">
                ...
                <div class="cols gap10">
                    <button class="tf-button w-full" type="submit">Add product multi images</button>
                    {{--                    <button class="tf-button style-1 w-full" type="submit">Save product</button>--}}
                    {{--                    <a href="#" class="tf-button style-2 w-full">Schedule</a>--}}
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            categorySelect.addEventListener('change', function () {
                ...
                if (categoryId) {
                    fetch(`/admin/product/subcategories/get-subcategories/${categoryId}`)
