                    ...
                    @foreach($products as $item)
                        <li class="product-item gap14">
                            ...
                            <div class="flex items-center justify-between gap20 flex-grow">
                                ...
                                <form method="POST" action="{{ route('product.destroy', ['product' => $item->id]) }}">
                                    @csrf @method('DELETE')
                                <div class="list-icon-function">
                                    <div class="item eye">
                                        <a href="{{ route('product.show', ['product' => $item->id]) }}" class="text-primary"><i class="icon-eye"></i></a>
                                    </div>
                                    <div class="item edit">
                                        <a href="{{ route('product.edit', ['product' => $item->id]) }}" class="text-success"><i class="icon-edit-3"></i></a>
                                    </div>
                                    <div class="item">
