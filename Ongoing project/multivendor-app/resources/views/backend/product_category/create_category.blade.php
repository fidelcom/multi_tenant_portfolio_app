        ...
        <div class="col-12 mb-20">
            <div class="wg-box">
                ...
                <div class="row">
                    <div class="col-12 mb-20">
                        <div>
                            <form class="" action="{{ route('product.categories.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <fieldset class="name mb-24">
                                    <div class="body-title mb-10">Category Name <span class="tf-color-1">*</span></div>
                                    <input class="" type="text" placeholder="Category Name" name="name" tabindex="0" value="" aria-required="true" required="">
                                </fieldset>
