<div class="section-menu-left">
    <div class="box-logo">
        <a href="{{ route('admin.dashboard') }}" id="site-logo-inner">
            <img class="" id="logo_header" alt="" src="{{ asset('admin/images/logo/logo.png') }}" data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" >
        </a>
        ...
        <div class="center-item">
            ...
            <ul class="menu-list">
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('banner.home') }}" class="">
                                <div class="text">All Banners</div>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a href="{{ route('banner.create') }}" class="">
                                <div class="text">Create Banner</div>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('slider.home') }}" class="">
                                <div class="text">All Sliders</div>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a href="{{ route('slider.create') }}" class="">
                                <div class="text">Create Slider</div>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="sub-menu-item">
                            <a href="{{ route('product.home') }}" class="">
                ...
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('product.categories.home') }}" class="">
                                <div class="text">Category list</div>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a href="{{ route('product.categories.create') }}" class="">
                ...
                <li class="menu-item has-children">
                    <a href="javascript:void(0);" class="menu-item-button">
                        <div class="icon"><i class="icon-layers"></i></div>
                        <div class="text">Product Subcategory</div>
                    </a>
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('product.subcategories.home') }}" class="">
                                <div class="text">Subcategory list</div>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a href="{{ route('product.subcategories.create') }}" class="">
                ...
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('admin.all.user') }}" class="">
...
{{--                        </li>--}}
                ...
                <li class="menu-item has-children">
                    ...
                    <ul class="sub-menu">
                        <li class="sub-menu-item">
                            <a href="{{ route('admin.all.vendor') }}" class="">
                                <div class="text">All Vendor</div>
                            </a>
                        </li>
                        <li class="sub-menu-item">
                            <a href="{{ route('admin.vendor.create') }}" class="">
                                <div class="text">Add new Vendor</div>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="bot text-center">
        <div class="wrap">
            <div class="mb-20">
                <img src="{{ asset('admin/images/menu-left/img-bot.png') }}" alt="">
            </div>
            <div class="mb-20">
