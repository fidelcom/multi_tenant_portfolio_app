                        ...
                        <div class="col-12 mb-20">
                            <div class="shop-item">
                                ...
                                <div class="flex-grow flex items-center justify-between gap20">
                                    ...
                                    <div class="body-text">
                                        <form action="{{ route('banner.destroy', ['banner' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                                            @csrf @method('DELETE')
                                            <a href="{{ route('banner.edit', ['banner' => $item->id]) }}" class="btn btn-info" title="Edit"><i class="icon-pen-tool"></i></a>
