    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                ...
                <a class="tf-button style-1 w208" href="{{ route('admin.user.create') }}"><i class="icon-plus"></i>Add new</a>
            </div>
                            ...
                            <div class="flex items-center justify-between gap20 flex-grow">
                                ...
                                <div class="body-text">
                                    ...
                                    <span class="badge rounded-pill p-2 bg-success capitalize">{{ $user->status }}</span>
                                        <span><a href="" class="btn btn-danger">Suspend User</a> </span>
                                    @else
                                        <span class="badge rounded-pill p-2 bg-danger capitalize">Deactivated</span>
                                        <span><a href="" class="btn btn-success">Activate Users</a> </span>
                                    @endif
                                </div>
                                <div class="list-icon-function">
                                    <a href="{{ route('admin.user.show', ['user' => $user->id]) }}" class="item eye">
                                        <i class="icon-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.user.edit', ['user' => $user->id]) }}" class="item edit">
