...
@section('admin')
    ...
    <div class="main-content-wrap">
        ...
        <!-- add-new-user -->
        <form class="form-add-new-user form-style-2" method="POST" action="{{ route('admin.user.update', ['user' => $user->id]) }}">
            @csrf @method('PUT')
            <div class="wg-box">
                <div class="left">
                ...
                <div class="right flex-grow">
                    <fieldset class="name mb-24">
                        ...
                        <input class="flex-grow" type="text" placeholder="Username" name="username" tabindex="0" value="{{ $user->username }}" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name mb-24">
                        <div class="body-title mb-10">First Name</div>
                        <input class="flex-grow" type="text" placeholder="First Name" name="first_name" tabindex="0" value="{{ $user->first_name }}" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name mb-24">
                        <div class="body-title mb-10">Last Name</div>
                        <input class="flex-grow" type="text" placeholder="Last Name" name="last_name" tabindex="0" value="{{ $user->last_name }}" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name mb-24">
                        <div class="body-title mb-10">Phone No</div>
                        <input class="flex-grow" type="text" placeholder="Phone number" name="phone" tabindex="0" value="{{ $user->phone }}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="password">
                        ...
                        <input class="password-input" type="password" placeholder="Confirm password" name="password_confirmation" tabindex="0" value="" aria-required="true" >
                        <span class="show-pass">
                                                    <i class="icon-eye view"></i>
                                                    <i class="icon-eye-off hide"></i>
                                                </span>
