    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Add New Vendor</div>
                </li>
            </ul>
        </div>
        <!-- add-new-user -->
        <form class="form-add-new-user form-style-2" method="POST" action="{{ route('admin.vendor.store') }}">
            @csrf
            <div class="wg-box">
                <div class="left">
                    ...
                    <fieldset class="name mb-24">
                        ...
                        <input class="flex-grow" type="text" placeholder="Organization Name" name="organization" tabindex="0" value="" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name mb-24">
                        <div class="body-title mb-10">Business Address</div>
                        <input class="flex-grow" type="text" placeholder="Organization address" name="organization_address" tabindex="0" value="" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name mb-24">
                        <div class="body-title mb-10">Business Phone</div>
                        <input class="flex-grow" type="text" placeholder="Organization phone no" name="organization_phone" tabindex="0" value="" aria-required="true" required="">
                    </fieldset>
                    <fieldset class="name mb-24">
                        <div class="body-title mb-10">Business Email</div>
                        <input class="flex-grow" type="text" placeholder="Organization Email" name="organization_email" tabindex="0" value="" aria-required="true" required="">
                    </fieldset>
                </div>
